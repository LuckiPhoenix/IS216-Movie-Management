  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="px-8 py-20">
        <div className="relative w-full rounded-[3rem] overflow-hidden bg-gradient-to-r from-tickify-pink/20 to-tickify-purple/20 border border-white/10 p-12 md:p-20 text-center">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 text-lg mb-10">
              Join thousands of digital movie explorers who trust Tickify for
              the ultimate cosmic cinema experience in the virtual realm.
            </p>
